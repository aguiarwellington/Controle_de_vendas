...
type
  ...
  public
    ...
    procedure ListarId(MemTable,MemItens: TFDMemTable;
                             id_pedido: integer);

    procedure Inserir(id_usuario, id_cliente: integer;
                        dt_pedido: TDate;
                        vl_total: double;
                        itens: TJSONArray);
...
procedure TDmPedido.ListarId(MemTable,MemItens: TFDMemTable;
                             id_pedido: integer);
var
    resp: IResponse;
    json: TJSONObject;
...
begin
    ...
    MemItens.LoadFromJSON(itens,false);
    MemTable.LoadFromJSON(itens);
end;
